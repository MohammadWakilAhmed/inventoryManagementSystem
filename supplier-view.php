                        ...
                        callback: function(isDelete){
                            if(isDelete){
                                ...
                                success: function(data){
                                    ...
                                    supplierName + ' deleted successfully!' : ' Error deleting product!';
                        ...
                        message:'<form action="database/add.php" method="POST" enctype="multipart/form-data" id="editSupplierForm">\
                            <div class="appFormInputContainers">\
                                ...
                                <div class="appFormInputContainers">\
                                    ...
                                    <input type="text"class="appFormInput" value="'+ supplierDetails.supplier_location +'" id="supplier_location" placeholder="Enter product supplier location..." name="supplier_location" />\
                                </div>\
                                <div class="appFormInputContainers">\
                                    <label for="email">Email Address</label>\
                                    <input type="text"class="appFormInput" value="'+ supplierDetails.email +'" id="email" placeholder="Enter supplier email..." name="email" />\
                                </div>\
                                <div class="appFormInputContainers">\
                                    <label for="products">Products</label>\
                                    <select class="supplierOption" name="products[]" id="products" multiple="">\
                                        <option class="supplierOption" value="">Select Supplier</option>\
                                        ' + productOptions + '\
                                    </select>\
                                </div>\
                                <input type="hidden" name="sid" id="sid" value="'+ supplierDetails.id +'" />\
                                <input type="submit" value="submit" id="editSupplierSubmitBtn" class="hidden" style="border-style: solid !important; border-color: #a19c9c;" />\
                                </form>\
                                ',
